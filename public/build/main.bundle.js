...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Router; });\n/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! . */ \"./public/javascripts/App/index.js\");\n/* harmony import */ var _Components_IndexPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Components/IndexPage */ \"./public/javascripts/Components/IndexPage/index.js\");\n/* harmony import */ var _Components_BoardPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Components/BoardPage */ \"./public/javascripts/Components/BoardPage/index.js\");\n\n\n\n\nclass Router {\n  constructor() {\n    this.currentPage = null;\n\n    this.bindEvents = this.bindEvents.bind(this);\n    this.loadPage = this.loadPage.bind(this);\n    this.navigate = this.navigate.bind(this);\n    this.displayMessage = this.displayMessage.bind(this);\n\n    this.bindEvents();\n  }\n\n  bindEvents() {\n    window.addEventListener(\"replacestate\", this.loadPage);\n    window.addEventListener(\"pushstate\", this.loadPage);\n    window.addEventListener(\"popstate\", this.loadPage);\n  }\n\n  displayMessage(message) {\n    new ___WEBPACK_IMPORTED_MODULE_0__[\"MessageBox\"]({ message: message });\n  }\n\n  navigate(path) {\n    history.pushState({}, path, path);\n    this.loadPage();\n  }\n\n  loadPage() {\n    const path = location.pathname;\n    const pageProps = {\n      navigate: this.navigate,\n      displayMessage: this.displayMessage\n    }\n\n    if (this.currentPage) {\n      this.currentPage.removeEventListeners();\n    }\n\n    if (path === '/') {\n      this.currentPage = new _Components_IndexPage__WEBPACK_IMPORTED_MODULE_1__[\"IndexMain\"](pageProps);\n    } else if (path.match(/^\\/boards\\/\\w+$/)) {\n      this.currentPage = new _Components_BoardPage__WEBPACK_IMPORTED_MODULE_2__[\"BoardIndex\"](pageProps);\n    }\n  }\n}\n\n\n//# sourceURL=webpack:///./public/javascripts/App/Router.js?");
...
/***/ "./public/javascripts/Components/BoardPage/BoardHeader.js":
/*!****************************************************************!*\
  !*** ./public/javascripts/Components/BoardPage/BoardHeader.js ***!
  \****************************************************************/
/*! exports provided: default */
...
/*!**********************************************************!*\
  !*** ./public/javascripts/Components/BoardPage/index.js ***!
  \**********************************************************/
/*! exports provided: BoardIndex, BoardHeader, BoardContent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _BoardIndex_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BoardIndex.js */ \"./public/javascripts/Components/BoardPage/BoardIndex.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"BoardIndex\", function() { return _BoardIndex_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]; });\n\n/* harmony import */ var _BoardHeader_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BoardHeader.js */ \"./public/javascripts/Components/BoardPage/BoardHeader.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"BoardHeader\", function() { return _BoardHeader_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]; });\n\n/* harmony import */ var _BoardContent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./BoardContent.js */ \"./public/javascripts/Components/BoardPage/BoardContent.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"BoardContent\", function() { return _BoardContent_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]; });\n\n\n\n\n\n\n//# sourceURL=webpack:///./public/javascripts/Components/BoardPage/index.js?");
